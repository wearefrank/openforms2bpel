<xsl:stylesheet exclude-result-prefixes="xs xsl zgw" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:zgw="http://google.com/zgw" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" version="2.0" >
    ...
    <xsl:function name="zgw:convertZdsArchiefNominatieToZgwArchiefNominatie">
    	<xsl:param name="zgwArchiefNominatie" as="xs:string"/>
        <xsl:choose>
            <xsl:when test="upper-case($zgwArchiefNominatie)='Y'">vernietigen</xsl:when>
    ...
    <xsl:function name="zgw:toZgwBoolean" as="xs:string">
    	<xsl:param name="zdsBoolean" as="xs:string"/>
		<xsl:choose>
      		<xsl:when test="upper-case($zdsBoolean)='Y'">true</xsl:when>
